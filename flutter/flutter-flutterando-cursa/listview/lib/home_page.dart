...
import 'package:listview/app_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold( // scaffold facilita a construção do app
      ...
      body: Container( // geralmente se envolve uma column com um container pois com ele é possível alterar a largura
        ...
        child: ListView( // permite um scrolling
          ...
          children: [ // é um array de child que são colocados enfileirados
            ...
            Text('Contador: $counter'),
            DarkThemeSwitch(),
            Row( // mesmo que uma column, mas na horizontal
              mainAxisAlignment: MainAxisAlignment.spaceAround, // centraliza no centro do eixo principal, que nesse caso é uma linha
              crossAxisAlignment: CrossAxisAlignment.center,
              /* referente aos filhos da row, se for start,
